...
// (P3-19). No external dependency: HMAC-SHA1 via Node's crypto, base32 via a
// small hand-rolled codec (there's no built-in one).
// ============================================================
...
export function otpauthUri(username, secret, issuer = 'CryptoPro Charts') {
